...
<head>
  ...
  <title>Informações - <?= $cliente['nome'] ?></title>
</head>
        ...
        <main>
            <table>
                <tr>
                  ...
                  <th><p class="title">CANCELAR</p></th>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                      <form method="post" action="../src/compra/cruds/delete.php">
                            <input type="hidden" name="id_compra" value="<?= $compra['id_compra']; ?>">
                            <input type="hidden" name="id_veiculo" value="<?= $compra['id_veiculo']; ?>">
                            <button type="submit" class="deletar" onclick="return confirm('Tem certeza que deseja cancelar a compra?');"><p class="sub-title">Cancelar</p></button>
                        </form>
                    </td>
                </tr>
            <?php } ?>
